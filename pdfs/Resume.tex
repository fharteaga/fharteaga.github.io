...
\textit{Economist in Tech | Ph.D. Economics, UC Berkeley (2024)}\\[3pt]
San Francisco, CA | \href{mailto:fharteaga@gmail.com}{fharteaga@gmail.com} | +1 (510) 365-9707 | \href{https://fharteaga.github.io/}{fharteaga.github.io}
\end{center}

% Experience Section
\section*{EXPERIENCE}
\noindent
\textbf{Amazon, PXT Central Science} -- \textit{Economist}  \hfill San Francisco, CA $|$ May 2024 - Present % Company name 
\begin{itemize}
    \item Conducted program evaluation and data-driven analysis to inform decision-making in corporate HR and organizational design, focusing on employee experience and workforce dynamics. % Job responsibilities and achievements
\end{itemize}
\noindent
\textbf{ConsiliumBots} -- \textit{Research Affiliate}  \hfill New York, NY $|$ May 2019 - May 2024 % Company name 
\begin{itemize}
...
\end{itemize}
\noindent
\textbf{University of California, Berkeley} -- \textit{Teaching assistant} \hfill Berkeley, CA $|$ August 2019 - May 2025
\begin{itemize}
...
\noindent
\textbf{Predicting risky school choice applicants} \hfill   2017 – 2024 
\begin{itemize}
...
% Education Section
\section*{EDUCATION}
\textbf{University of California, Berkeley}, Berkeley, CA \hfill  May 2024\\ % University name and location
...
\section*{SKILLS}
\begin{itemize}
    \item \textbf{Programming:} Python, Matlab, Stata, R, Java, SQL.
